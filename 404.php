...
<head>
    ...
    <link href="css/css_404.css" rel="stylesheet" type="text/css" media="all" />
      ...
      <g id="train">
        ...
        <g id="car-layers">
          ...
          <g id="Text">
            ...
            <text transform="translate(659.5 213.994)" class="st8 st10" font-size="18.025">
              Page not found.<a href="index.php">Back Home</a>
            </text>
          </g>
          <g id="ladders">
            <g id="ladder-f">
