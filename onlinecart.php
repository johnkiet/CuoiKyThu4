	...
	<div class="content">
		<div class="cartoption">
			...
			<div class="shopping">
				...
				<form action ="momopayment.php" method ="POST">
					<input type="hidden" name="total_congthanhtoan" value="<?php echo $sub_total + $vat?>">
					<button class="btn btn-success" name="redirect" id="redirect">MOMO</button>
				</form>
			</div>
		</div>
		<div class="clear"></div>
